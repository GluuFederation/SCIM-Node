...
module.exports = function (params) {
  ...
  function getSCIMConfigurations(domain) {
    ...
    return request(serviceProviderConfigRequestOption)
      .then(function (serviceProviderConfig) {
        try {
          const serviceProviderConfigJSON = JSON.parse(serviceProviderConfig);
        ...
        return request(resourceTypesRequestOption)
      })
      .then((resourceTypesConfig) => {
        try {
          const resourceTypesConfigJSON = JSON.parse(resourceTypesConfig);
