    ...
    return new Promise(function (resolve, reject) {
      ...
      return getSCIMConfigurations(params.domain)
        ...
        .then(function (rptDetail) {
          return retrieveUsers(userEndpoint, rptDetail.RPT.access_token, 0, 0)
        })
        .then(function (users) {
  ...
  module.getUsers = function getUsers(startIndex, count, callback) {
    return new Promise(function (resolve, reject) {
      ...
      return getSCIMConfigurations(params.domain)
        ...
        .then(function (rptDetail) {
          return retrieveUsers(userEndpoint, rptDetail.RPT.access_token, startIndex, count)
        })
        .then(function (users) {
          return resolve(users);
        })
  ...
  module.getUser = function getUser(id, callback) {
    return new Promise(function (resolve, reject) {
      ...
      return getSCIMConfigurations(params.domain)
        ...
        .then(function (rptDetail) {
          return retrieveUser(userEndpoint, rptDetail.RPT.access_token, id)
        })
        .then(function (users) {
          return resolve(users);
        })
  ...
  module.addUser = function addUser(userData, callback) {
    return new Promise(function (resolve, reject) {
      ...
      return getSCIMConfigurations(params.domain)
        ...
        .then(function (rptDetail) {
          return insertUser(userEndpoint, rptDetail.RPT.access_token, userData)
        })
        .then(function (users) {
          return resolve(users);
        })
  ...
  module.removeUser = function removeUser(id, callback) {
    return new Promise(function (resolve, reject) {
      ...
      return getSCIMConfigurations(params.domain)
        ...
        .then(function (rptDetail) {
          return deleteUser(userEndpoint, rptDetail.RPT.access_token, id)
        })
        .then(function (users) {
          return resolve(users);
        })
