...
module.exports = function (params) {
  ...
  function getSCIMConfigurations(domain) {
    return new Promise(function (resolve, reject) {
      resolve({
        "version" : "2.0",
        "authorization_supported" : [ "uma" ],
        "user_endpoint" : domain.concat("/identity/restv1/scim/v2/Users"),
        "group_endpoint" : domain.concat("/identity/restv1/scim/v2/Groups"),
        "bulk_endpoint" : domain.concat("/identity/restv1/scim/v2/Bulk"),
        "service_provider_endpoint" : domain.concat("/identity/restv1/scim/v2/ServiceProviderConfig"),
        "resource_types_endpoint" : domain.concat("/identity/restv1/scim/v2/ResourceTypes"),
        "fido_devices_endpoint" : domain.concat("/identity/restv1/scim/v2/FidoDevices"),
        "schemas_endpoint" : domain.concat("/identity/restv1/scim/v2/Schemas")
      })
    });
  }
